...
class ExtendedCupertinoTextSelectionToolbarWrapper extends StatefulWidget {
  ...
  _ExtendedCupertinoTextSelectionToolbarWrapperState createState() =>
      _ExtendedCupertinoTextSelectionToolbarWrapperState();
}

class _ExtendedCupertinoTextSelectionToolbarWrapperState
    extends State<ExtendedCupertinoTextSelectionToolbarWrapper> {
  ...
  @override
  void didUpdateWidget(ExtendedCupertinoTextSelectionToolbarWrapper oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    return ExtendedCupertinoTextSelectionToolbar._(
      ...
      child: items.isEmpty
          ? null
          : ExtendedCupertinoTextSelectionToolbarContent(
              isArrowPointingDown: widget.isArrowPointingDown,
              children: items,
            ),
    );
...
class ExtendedCupertinoTextSelectionToolbar
  ...
  const ExtendedCupertinoTextSelectionToolbar._({
    Key key,
    double barTopY,
    double arrowTipX,
...
class ExtendedCupertinoTextSelectionHandlePainter extends CustomPainter {
  const ExtendedCupertinoTextSelectionHandlePainter(this.color);
  ...
  @override
  bool shouldRepaint(ExtendedCupertinoTextSelectionHandlePainter oldDelegate) =>
...
class ExtendedCupertinoTextSelectionControls extends TextSelectionControls {
  ...
  Widget buildToolbar(
    ...
    return ExtendedCupertinoTextSelectionToolbarWrapper(
      arrowTipX: arrowTipX,
  ...
  Widget buildHandle(BuildContext context, TextSelectionHandleType type,
    ...
    final Widget handle = SizedBox.fromSize(
      size: desiredSize,
      child: CustomPaint(
        painter: ExtendedCupertinoTextSelectionHandlePainter(
...
class ExtendedCupertinoTextSelectionToolbarContent extends StatefulWidget {
  const ExtendedCupertinoTextSelectionToolbarContent({
    Key key,
  ...
  @override
  _ExtendedCupertinoTextSelectionToolbarContentState createState() =>
      _ExtendedCupertinoTextSelectionToolbarContentState();
}

class _ExtendedCupertinoTextSelectionToolbarContentState
    extends State<ExtendedCupertinoTextSelectionToolbarContent>
  ...
  @override
  void didUpdateWidget(ExtendedCupertinoTextSelectionToolbarContent oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    return DecoratedBox(
      ...
      child: FadeTransition(
        opacity: _controller,
        child: ExtendedCupertinoTextSelectionToolbarItems(
          page: _page,
...
class ExtendedCupertinoTextSelectionToolbarItems extends RenderObjectWidget {
  ExtendedCupertinoTextSelectionToolbarItems({
    Key key,
    @required this.page,
    @required this.children,
  ...
  @override
  ExtendedCupertinoTextSelectionToolbarItemsRenderBox createRenderObject(
      BuildContext context) {
    return ExtendedCupertinoTextSelectionToolbarItemsRenderBox(
  ...
  void updateRenderObject(BuildContext context,
      ExtendedCupertinoTextSelectionToolbarItemsRenderBox renderObject) {
    renderObject
      ..page = page
      ..dividerWidth = dividerWidth;
  }
  ...
  @override
  ExtendedCupertinoTextSelectionToolbarItemsElement createElement() =>
      ExtendedCupertinoTextSelectionToolbarItemsElement(this);
}

// The custom RenderObjectElement that helps paginate the menu items.
class ExtendedCupertinoTextSelectionToolbarItemsElement
    extends RenderObjectElement {
  ExtendedCupertinoTextSelectionToolbarItemsElement(
    ExtendedCupertinoTextSelectionToolbarItems widget,
  ) : super(widget);
  ...
  @override
  ExtendedCupertinoTextSelectionToolbarItems get widget =>
      super.widget as ExtendedCupertinoTextSelectionToolbarItems;

  @override
  ExtendedCupertinoTextSelectionToolbarItemsRenderBox get renderObject =>
      super.renderObject as ExtendedCupertinoTextSelectionToolbarItemsRenderBox;
  ...
  void visitChildren(ElementVisitor visitor) {
    ...
    for (final Element child in _children) {
      final Set<Element> forgottenChildren = _forgottenChildren;
      if (!forgottenChildren.contains(child)) {
        visitor(child);
      }
    }
  }
  ...
  @override
  void update(ExtendedCupertinoTextSelectionToolbarItems newWidget) {
...
class ExtendedCupertinoTextSelectionToolbarItemsRenderBox extends RenderBox
    with
  ...
  ExtendedCupertinoTextSelectionToolbarItemsRenderBox({
...
final TextSelectionControls extendedCupertinoTextSelectionControls =
